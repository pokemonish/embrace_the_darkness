...
public class SignOutServletTest extends AuthBasicTest {
    ...
    private SignOutServlet signOutServlet = new SignOutServlet(mockedFrontEnd);
    ...
    public void testAlreadyLoggedOutDoPost() throws ServletException, IOException {
        when(mockedFrontEnd.isAuthenticated(eq(String.valueOf(TEST_USER_ID)))).thenReturn(null);
    ...
    public void testCorrectDoPost() throws ServletException, IOException {
        when(mockedFrontEnd.isAuthenticated(eq(String.valueOf(TEST_USER_ID))))
                .thenReturn(TEST_USER_PROFILE).thenReturn(null);
        signOutServlet.doPost(mockedRequest, mockedResponse);
